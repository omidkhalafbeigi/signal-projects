...
def convolution(signal1, signal2):
    ...
    plt_signal1.plot(primary_signal1, color='black')
    plt_signal2.plot(primary_signal2, color='black')
    plt_convolve_orig.plot(signal.convolve(primary_signal1, primary_signal2), color='green')
    result = []
    biggest_signal = 0
    smallest_signal = 0
    ...
    plt_convolve.plot(result, color='green')
    plt.show()
